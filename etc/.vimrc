...
" Todo
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
au BufNewFile,BufRead *.todo so amido.vim
...
au FileType python so python.vim
autocmd FileType python map <buffer> <leader><space> :w!<cr>:!python %<cr>
autocmd FileType python so python_fold.vim
...
"Java comments
"autocmd FileType java source jcommenter.vim
...
" JavaScript section
"""""""""""""""""""""""""""""""
au FileType javascript so javascript.vim
...
if has("cscope")
  ...
  if filereadable("cscope.out")
      ...
      cs add /home/zz/project/mini2440/linux-2.6.32.2/cscope.out
  endif
      set csverb
endif
